export default class QuestAbilityData extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    ...
    return {
      ...
      learningPath: new fields.StringField({ required: false, blank: true, initial: "" }),
      pathOrder: new fields.NumberField({ required: true, integer: true, initial: 0, min: 0 })
    };
  }
}